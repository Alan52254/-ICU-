...
export const SOFA_ORGAN_MAP = {
  Resp:  { csvActual: 'sofa_resp',  label: 'Respiratory',    labelZh: '呼吸', color: '#3B82F6' },
  Coag:  { csvActual: 'sofa_coag',  label: 'Coagulation',    labelZh: '凝血', color: '#F59E0B' },
  Liver: { csvActual: 'sofa_liver', label: 'Liver',          labelZh: '肝臟', color: '#10B981' },
  CV:    { csvActual: 'sofa_cv',    label: 'Cardiovascular', labelZh: '心血管', color: '#EF4444' },
  CNS:   { csvActual: 'sofa_cns',   label: 'CNS',           labelZh: '中樞神經', color: '#8B5CF6' },
  Renal: { csvActual: 'sofa_renal', label: 'Renal',         labelZh: '腎臟', color: '#EC4899' },
};
